...
-Netlify – Plataforma utilizada para el despliegue de la aplicación.
...
Manejo asíncrono con Promesas: Todas las interacciones con Supabase usan funciones async/await para controlar flujos de datos y errores de manera eficiente.
...
Despliegue continuo facilitado por integraciones con plataformas como Netlify.

Podés clonar el repositorio ejecutando:
...
👉 https://taskify-project-ironhack.netlify.app/

👨‍💻 Autor
Desarrollado por Matías Morales en 2025 como proyecto personal para profundizar en Vue 3, Pinia y Supabase.

📄 Licencia
Este proyecto se desarrolla con fines educativos y no posee una licencia específica.
